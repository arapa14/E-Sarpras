                ...
                <form action="{{ route('response.store', $complaint->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <textarea id="feedback" name="feedback" rows="5" required
                            class="w-full border border-gray-300 rounded-lg p-3 focus:ring-blue-500 focus:border-blue-500" placeholder="{{ old('feedback', $complaint->responses->last()->feedback ?? 'Berikan feedback') }}"></textarea>
                    </div>
                            ...
                            <div class="image-upload-field">
                                <label for="after-image-1" class="relative group block">
                                    ...
                                    <img id="after-preview-1" src="#" alt="Preview Gambar Sesudah"
                                        class="mt-2 hidden object-cover w-full h-48 rounded-md">
                                    <button type="button"
                    ...
                    <div>
                        ...
                        <div class="flex space-x-6">
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 badge bg-yellow-100 text-yellow-600">Pending</span>
                            </label>
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 badge bg-blue-100 text-blue-600">Progress</span>
                            </label>
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 badge bg-green-100 text-green-600">Selesai</span>
                            </label>
                        </div>
                    </div>
