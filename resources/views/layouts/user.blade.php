...
<body class="bg-gray-50 font-sans">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <header class="fixed top-0 inset-x-0 z-30 bg-gradient-to-r from-blue-600 to-blue-800 shadow-md p-4 sm:hidden">
        ...
        <div class="flex flex-1 relative pt-16 sm:pt-0">
            <!-- Sidebar -->
            <nav id="sidebar"
                class="sidebar p-4 w-64 fixed inset-y-0 left-0 z-[49] transform -translate-x-full transition-transform duration-300 sm:relative sm:translate-x-0 sm:sticky sm:top-0 h-screen overflow-y-auto bg-gray-800">
