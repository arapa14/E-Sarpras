                    ...
                    <form id="systemSettingForm" action="{{ route('setting.update') }}" method="POST"
                        ...
                        <div class="flex justify-end">
                            <button type="button" @click="showModal = true"
                                class="flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg shadow-xl transition-all text-xl">
    ...
    <div x-data="{ showModal: false }" x-show="showModal" class="fixed inset-0 flex items-center justify-center z-50"
        ...
        <div class="bg-white rounded-lg shadow-2xl w-11/12 md:max-w-lg mx-auto p-8">
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button @click="document.getElementById('systemSettingForm').submit()"
