...
<head>
    ...
    <title>{{ $apk }} - 405 Method Not Allowed</title>
    <!-- Favicon SVG inline -->
    <link rel="icon"
...
<body class="min-h-screen bg-gradient-to-br from-purple-200 via-blue-200 to-indigo-200 flex items-center justify-center">
    <div class="container mx-auto px-4 py-8 fade-in">
        ...
        <header class="flex flex-col items-center mb-12">
            <div class="flex items-center space-x-4">
                ...
                <i class="fas fa-ban fa-3x text-indigo-600 icon-spin-slow"></i>
            </div>
        ...
        <main
            ...
            style="background-image: linear-gradient(to right, #667eea, #764ba2); background-origin: border-box;">
            <h2 class="text-8xl font-extrabold text-white mb-4 drop-shadow-lg animate-pulse">405</h2>
            <h3 class="text-4xl font-semibold text-white mb-4">Method Not Allowed</h3>
            <p class="text-xl text-gray-100 mb-8">
                Maaf, metode yang digunakan tidak diizinkan untuk mengakses halaman ini.
            </p>
            <a href="{{ url('/') }}"
