...
<body class="min-h-screen bg-gradient-to-br from-yellow-200 via-orange-200 to-red-200 flex items-center justify-center">
    <div class="container mx-auto px-4 py-8 fade-in">
        ...
        <header class="flex flex-col items-center mb-12">
            <div class="flex items-center space-x-4">
                ...
                <i class="fas fa-exclamation-triangle fa-3x text-red-600 icon-spin-slow"></i>
            </div>
        ...
        <main
            ...
            style="background-image: linear-gradient(to right, #f6ad55, #ed8936); background-origin: border-box;">
            <h2 class="text-8xl font-extrabold text-white mb-4 drop-shadow-lg animate-pulse">404</h2>
            <h3 class="text-4xl font-semibold text-white mb-4">Not Found</h3>
