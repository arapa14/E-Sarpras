...
<head>
    ...
    <title>{{ $apk }} - 419 Page Expired</title>
    <!-- Favicon SVG inline -->
    <link rel="icon"
...
<body class="min-h-screen bg-gradient-to-br from-red-200 via-pink-200 to-purple-200 flex items-center justify-center">
    <div class="container mx-auto px-4 py-8 fade-in">
        ...
        <header class="flex flex-col items-center mb-12">
            <div class="flex items-center space-x-4">
                ...
                <i class="fas fa-hourglass-half fa-3x text-purple-600 icon-spin-slow"></i>
            </div>
        ...
        <main
            ...
            style="background-image: linear-gradient(to right, #ec4899, #f472b6); background-origin: border-box;">
            <h2 class="text-8xl font-extrabold text-white mb-4 drop-shadow-lg animate-pulse">419</h2>
            <h3 class="text-4xl font-semibold text-white mb-4">Page Expired</h3>
            <p class="text-xl text-gray-100 mb-8">
                Maaf, halaman telah kedaluwarsa. Silakan muat ulang halaman atau kembali ke beranda.
            </p>
            <a href="{{ url('/') }}"
