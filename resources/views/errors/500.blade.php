...
<head>
    ...
    <title>{{ $apk }} - 500 Internal Server Error</title>
    <!-- Favicon SVG inline -->
    <link rel="icon"
...
<body class="min-h-screen bg-gradient-to-br from-red-300 via-red-400 to-red-500 flex items-center justify-center">
    <div class="container mx-auto px-4 py-8 fade-in">
        ...
        <header class="flex flex-col items-center mb-12">
            <div class="flex items-center space-x-4">
                ...
                <i class="fas fa-cogs fa-3x text-white icon-spin-slow"></i>
            </div>
            <h1 class="mt-6 text-5xl font-extrabold text-white flex items-center space-x-3">
                <span>{{ $apk }}</span>
        ...
        <main
            ...
            style="background-image: linear-gradient(to right, #f87171, #ef4444); background-origin: border-box;">
            <h2 class="text-8xl font-extrabold text-white mb-4 drop-shadow-lg animate-pulse">500</h2>
            <h3 class="text-4xl font-semibold text-white mb-4">Internal Server Error</h3>
